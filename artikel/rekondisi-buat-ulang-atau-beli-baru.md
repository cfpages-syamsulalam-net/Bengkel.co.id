...
- **Writer task:** Expand this file into one complete article answering: “Kapan Komponen Layak Direkondisi, Dibuat Ulang, atau Dibeli Baru”
- **Reader and situation:** Industrial buyer with worn or unavailable part
- **Reader outcome:** Distinguish refurbishment, rebuild, remanufacture, reverse engineering, and replacement by evidence and risk
- **Primary intent:** Choose component intervention class
...
- **Scope boundary:** Excludes IP copying, OEM approval, and machining details; BKL-09-A03 owns component workflow
- **Final public route:** `/artikel/rekondisi-buat-ulang-atau-beli-baru.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kapan Komponen Layak Direkondisi, Dibuat Ulang, atau Dibeli Baru**.
...
- **Tie back to this article:** Keep the explanation specific to “Kapan Komponen Layak Direkondisi, Dibuat Ulang, atau Dibeli Baru”.
