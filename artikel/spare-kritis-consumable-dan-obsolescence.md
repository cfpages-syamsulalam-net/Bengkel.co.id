...
- **Writer task:** Expand this file into one complete article answering: “Spare Kritis, Consumable, dan Obsolescence untuk Mengurangi Downtime”
- **Reader and situation:** Facility depends on hard-to-source parts
- **Reader outcome:** Classify criticality, lead time, shelf/storage needs, interchangeability, preservation, reorder trigger, obsolete-part options, and records
- **Primary intent:** Plan spares and obsolescence
...
- **Scope boundary:** No inventory quantity guarantee or substitution approval; BKL-06-A05/A06 own sourcing/equivalence
- **Final public route:** `/artikel/spare-kritis-consumable-dan-obsolescence.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spare Kritis, Consumable, dan Obsolescence untuk Mengurangi Downtime**.
...
- **Tie back to this article:** Keep the explanation specific to “Spare Kritis, Consumable, dan Obsolescence untuk Mengurangi Downtime”.
