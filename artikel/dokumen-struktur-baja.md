---
article_id: BKL-10-A02
title: "Dokumen Struktur Baja: Gambar, Material, Sambungan, dan ITP"
slug: "dokumen-struktur-baja"
description: "Explain design/shop/erection drawings, material certificates, connection details, WPS, inspection plan, changes, and as-built"
status: outline
publication_date: "2025-11-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BKL-10
primary_intent: "Identify structural fabrication records"
reader_community: "Bengkel.co.id"
reader_address: "Kawan Bengkel.co.id"
final_route: "/artikel/dokumen-struktur-baja.html"
...
# Dokumen Struktur Baja: Gambar, Material, Sambungan, dan ITP

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Dokumen Struktur Baja: Gambar, Material, Sambungan, dan ITP”
- **Reader and situation:** Owner procuring steelwork
- **Reader outcome:** Explain design/shop/erection drawings, material certificates, connection details, WPS, inspection plan, changes, and as-built
- **Primary intent:** Identify structural fabrication records
...
- **Scope boundary:** Does not determine which SNI clause applies; engineer and contract own applicability
- **Final public route:** `/artikel/dokumen-struktur-baja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Dokumen Struktur Baja: Gambar, Material, Sambungan, dan ITP**.
...
- **Tie back to this article:** Keep the explanation specific to “Dokumen Struktur Baja: Gambar, Material, Sambungan, dan ITP”.
