...
- **Writer task:** Expand this file into one complete article answering: “Menilai Perbaikan Sementara: Batas Waktu, Monitoring, dan Stop Condition”
- **Reader and situation:** Downtime pressure encourages a quick fix
- **Reader outcome:** Define authority, load/service restriction, inspection frequency, expiry, signage, contingency, and permanent action
- **Primary intent:** Govern a temporary repair
...
- **Scope boundary:** No temporary repair recipe for structure, pressure, lifting, or rotating equipment; system experts own approval
- **Final public route:** `/artikel/menilai-perbaikan-sementara.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menilai Perbaikan Sementara: Batas Waktu, Monitoring, dan Stop Condition**.
...
- `BKL-04-A01` → `/artikel/matriks-memilih-reparasi-atau-ganti.html` — Matriks Memilih Reparasi atau Ganti Berdasarkan Risiko dan Bukti
...
- **Tie back to this article:** Keep the explanation specific to “Menilai Perbaikan Sementara: Batas Waktu, Monitoring, dan Stop Condition”.
