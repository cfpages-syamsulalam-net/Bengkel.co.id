...
- **Writer task:** Expand this file into one complete article answering: “Rework Las: Kapan Diperbolehkan dan Bukti Apa yang Harus Diulang”
- **Reader and situation:** Inspection finds a nonconformance
- **Reader outcome:** Describe authorization, defect mapping, removal, material condition, repair procedure, reinspection, repeated repair, and records
- **Primary intent:** Control weld repair cycle
...
- **Scope boundary:** Does not select removal method or acceptance level; BKL-14 owns NCR and qualified code authority decides
- **Final public route:** `/artikel/rework-las-dan-bukti-pengulangan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Rework Las: Kapan Diperbolehkan dan Bukti Apa yang Harus Diulang**.
...
- **Tie back to this article:** Keep the explanation specific to “Rework Las: Kapan Diperbolehkan dan Bukti Apa yang Harus Diulang”.
