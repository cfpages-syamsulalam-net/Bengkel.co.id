...
description: "Define numerator/denominator, period, scope, exclusions, data source, gaming risks, trend, target ownership, and action for useful KPIs"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “KPI Bengkel yang Berguna: Rework, On-Time, Response, Downtime, dan Repeat Failure”
- **Reader and situation:** Workshop or buyer wants proof beyond testimonials
- **Reader outcome:** Define numerator/denominator, period, scope, exclusions, data source, gaming risks, trend, target ownership, and action for useful KPIs
- **Primary intent:** Evaluate service performance metrics
...
- **Scope boundary:** No invented benchmark or claim that one KPI proves quality; real records and context own interpretation
- **Final public route:** `/artikel/kpi-bengkel-yang-berguna.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **KPI Bengkel yang Berguna: Rework, On-Time, Response, Downtime, dan Repeat Failure**.
...
- **Tie back to this article:** Keep the explanation specific to “KPI Bengkel yang Berguna: Rework, On-Time, Response, Downtime, dan Repeat Failure”.
