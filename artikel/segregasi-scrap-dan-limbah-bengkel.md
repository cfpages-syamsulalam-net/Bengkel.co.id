---
article_id: BKL-19-A03
title: "Scrap Logam, Tabung, Oli, dan Bahan Terkontaminasi: Jangan Dicampur Sembarangan"
slug: "segregasi-scrap-dan-limbah-bengkel"
description: "Explain identification, contamination, sharp/heavy handling, cylinder ownership, oil/solvent separation, storage, records, and approved destinations"
status: outline
publication_date: "2026-06-18"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: BKL-19
primary_intent: "Plan waste segregation"
reader_community: "Bengkel.co.id"
reader_address: "Kawan Bengkel.co.id"
final_route: "/artikel/segregasi-scrap-dan-limbah-bengkel.html"
...
# Scrap Logam, Tabung, Oli, dan Bahan Terkontaminasi: Jangan Dicampur Sembarangan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Scrap Logam, Tabung, Oli, dan Bahan Terkontaminasi: Jangan Dicampur Sembarangan”
- **Reader and situation:** Mixed streams reduce recovery and raise risk
- **Reader outcome:** Explain identification, contamination, sharp/heavy handling, cylinder ownership, oil/solvent separation, storage, records, and approved destinations
- **Primary intent:** Plan waste segregation
...
- **Scope boundary:** No disposal destination endorsement or waste-code assignment; local verification and authorized handlers govern
- **Final public route:** `/artikel/segregasi-scrap-dan-limbah-bengkel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Scrap Logam, Tabung, Oli, dan Bahan Terkontaminasi: Jangan Dicampur Sembarangan**.
...
- `BKL-19-A01` → `/artikel/peta-aliran-limbah-bengkel.html` — Peta Aliran Limbah Bengkel: Scrap, Swarf, Oli, Solvent, Cat, dan Lap
- `BKL-19-A02` → `/artikel/sds-label-dan-penyimpanan-bahan-kimia-bengkel.html` — SDS, Label, dan Penyimpanan Bahan Kimia Bengkel
- `BKL-19-A04` → `/artikel/dampak-lingkungan-pekerjaan-bengkel-di-lokasi.html` — Asap, Debu, Bising, Getaran, dan Keluhan Tetangga di Pekerjaan Lapangan
...
- **Tie back to this article:** Keep the explanation specific to “Scrap Logam, Tabung, Oli, dan Bahan Terkontaminasi: Jangan Dicampur Sembarangan”.
